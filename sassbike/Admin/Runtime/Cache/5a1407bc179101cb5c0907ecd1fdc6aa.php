...
<body>
			...
			<div class="col-lg-10">
				<div id="infoDiv" class="info-content">
					<div class="offer-panl">
						<div class="container">
					        <form class="offer-form" action="__URL__/do_alterBike?bikeId=<?php echo ($bikeInfo["bikeId"]); ?>&userId=<?php echo ($bikeInfo["userId"]); ?>" method="post" enctype="multipart/form-data">
					        	<!-- <h3 class="form-head">添加车辆</h3> -->
					            <div class="row">
					            	<div class="form-group col-md-6">
						                <label class="col-form-label" for="bikeBrand">车辆品牌：</label>
						                <input type="text" class="form-control" id="bikeBrand" name="bikeBrand" value="<?php echo ($bikeInfo["brand"]); ?>" autocomplete="off" aria-describedby="brandHelp" placeholder="如：飞鸽">
						                <small id="brandHelp" class="form-text text-muted"></small>
						            </div>

						             <div class="form-group col-md-6">
						                <label for="offerPhone" class="col-form-label">手机号：（必填）</label>
						                <input type="text" class="form-control" id="offerPhone" name="phone" value="<?php echo ($bikeInfo["phone"]); ?>" autocomplete="off" placeholder="手机号">
								...
								<div class="row">
									<div class="form-group col-md-6">
						                ...
						                <input type="text" class="form-control" id="price" name="price" value="<?php echo ($bikeInfo["price"]); ?>" autocomplete="off" placeholder="若不填，则默认“面议”">
						            </div>

						            <div class="form-group col-md-6">
						                <label for="location" class="col-form-label">车辆位置：（必填）</label>
						                <input id="location" class="form-control" name="location" value="<?php echo ($bikeInfo["location"]); ?>" placeholder="如：理工大西门">
								...
								<div class="form-group">
							      	...
							      	<select id="howOld" name="howOld" class="form-control">
								...
								<div class="row">
						            <div class="form-group col-md-6">
						                ...
						                <div class="form-check form-check-inline">
										  	<label class="form-check-label">
										    	<input class="form-check-input" type="radio" id="bike" name="bikeKinds" value="bike"> 自行车
										  	</label>
										</div>
										<div class="form-check form-check-inline">
										  	<label class="form-check-label">
										    	<input class="form-check-input" type="radio" id="elect" name="bikeKinds" value="elect"> 电动车
										  	</label>
										</div>
									</div>
									...
									<div class="form-group col-md-6">
										...
										<div class="form-check form-check-inline">
										  	<label class="form-check-label">
										    	<input class="form-check-input" type="radio" id="boy" name="sexKinds" value="m"> 男式
										  	</label>
										</div>
										<div class="form-check form-check-inline">
										  	<label class="form-check-label">
										    	<input class="form-check-input" type="radio" id="girl" name="sexKinds" value="f"> 女式
										  	</label>
										</div>
						            </div>
								</div>
					            ...
					            <button id="alterBikeBtn" type="submit" class="btn btn-purple">修改车辆信息</button>
					        </form>
					    </div>
					</div>
    ...
    <script type="text/javascript">
		...
		//判断车辆新旧程度
		var howOld="<?php echo ($bikeInfo["howOld"]); ?>";
		var select=document.getElementById('howOld');
		var opts=['全新','九成新','八成新','七成新','六成新','五成新','四成新','三成新','二成新','一成新'];
		var flag;
		...
		select.options[flag].selected=true;

		var bikeKinds="<?php echo ($bikeInfo["bikeKinds"]); ?>";
		var sexKinds="<?php echo ($bikeInfo["sexKinds"]); ?>";
		
		if(bikeKinds=="bike"){
			$("#bike").attr("checked",true);

		}else if(bikeKinds=="elect"){
			$("#elect").attr("checked",true);
