				...
				<div id="admin-nav" data-children=".item">
					<div class="item">
					    ...
					    <div id="user-nav" class="collapse show" role="tabpanel">
				       		<ul class="mb-3">
				       			<li>
				       		 		<a class="nav-a active" href="__APP__/User/userList">
				       		 			用户列表
				       		 		</a>
				       		 	</li>
				       		 	<li>
			...
			<div class="col-lg-10">
				<div id="infoDiv" class="info-content">
					<table class="table table-hover">
						...
						<tbody>
							<?php if(is_array($userInfo)): $i = 0; $__LIST__ = $userInfo;if( count($__LIST__)==0 ) : echo "没有任何记录" ;else: foreach($__LIST__ as $key=>$userInfo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><?php echo ($userInfo["joinTime"]); ?></td>
									<td><a class="fontGreen" href="__APP__/User/alterUser?userId=<?php echo ($userInfo["userId"]); ?>">编辑</a></td>
									<td><a class="fontRed" href="__APP__/User/do_deleteUser?userId=<?php echo ($userInfo["userId"]); ?>">删除</a></td>
