...
<body>
                    ...
                    <div class="col-md-4">                     
                        <div class="form-group">
                            <div id="imgPreview" class="alt-user-img">
                                <img id="pic" class="person-img" src="__ROOT__/Uploads/bikeImgs/<?php echo ($_SESSION['userId']); ?>/<?php echo ($bikeInfo["bikeImg"]); echo ($bikeInfo["bikeExtension"]); ?>" alt="车辆照片" />
                            </div>
                        </div>
                    </div>
 ...
 if($bikeInfo['offerState']==0){ ?>
                                <li class="list-group-item row">
                                    ...
                                    <label class="fontRed"><?php echo ($offerState[$bikeInfo['offerState']]); ?></label>
                                </li>
                                ...
                                <li class="list-group-item row">
                                    <label for="offerNum" class=" col-form-label">车辆状态：</label>
                                    <label class="fontGreen"><?php echo ($offerState[$bikeInfo['offerState']]); ?></label>
                                </li>
                                ...
                                <li class="list-group-item row">
                                    ...
                                    <label><?php echo ($bikeInfo["allTime"]); ?></label>
                                </li>

                                <li class="list-group-item row">
                                    <label for="offerNum" class=" col-form-label">总金额：</label>
                                    <label><?php echo ($bikeInfo["allPrice"]); ?></label>
                                </li>
                                ...
                                <li class="list-group-item row">
                                    ...
                                    <label><?php echo ($bikeInfo["stopOfferTime"]); ?></label>
                                </li>
                                <?php  } ?>
                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function($){
            $('#stopOfferBtn').click(function(){
                ...
                var offerId='<?php echo ($bikeInfo["offerId"]); ?>';
                // alert(offerId);
