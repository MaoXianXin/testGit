        ...
        <div class="container">
             <form>
                <div class="form-group">
                    <img class="user-img" src="__ROOT__/Uploads/headPhotos/<?php echo ($_SESSION['userId']); ?>/<?php echo ($userInfo["headPhoto"]); echo ($userInfo["exten"]); ?>"/>
                </div>
            </form>
        </div>
    </div>
                    ...
                    <form method="post" action="__URL__/upload" enctype="multipart/form-data">
                        <div class="form-group">
                            <div id="imgPreview" class="alt-user-img">
                                <img id="pic" class="person-img" src="__ROOT__/Uploads/headPhotos/<?php echo ($_SESSION['userId']); ?>/<?php echo ($userInfo["headPhoto"]); echo ($userInfo["exten"]); ?>" alt="用户头像" title="点击可修改头像" />
                            </div>
